...
| Reference descriptions classified | 1,003 | 1,003 | 100.00% |
| Classified descriptions expressible | 1,003 | 1,003 | 100.00% |
...
- The 120 formerly unclassified references are now semantically recovered, but exact runtime equivalents remain **0/120 (`NOT_FOUND`)**: 56 require persistent source facts, 13 normalized live rules, 43 game-specific adapters, and 8 sequence-sensitive observation contracts. None are generated until their entire predicate is provable.
