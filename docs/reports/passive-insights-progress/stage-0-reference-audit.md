...
The authenticated corpus contains 1,003 base achievements across the 11 exact official English Generation I–III controls. The fail-closed classifier resolved 883 / 1,003 references (88.04%); 120 / 1,003 (11.96%) remain explicitly unclassified. All 883 classified references have a commit-safe semantic binding and generic independently written template metadata.
...
| Section 4.3 fail-closed semantic classification | Deterministic family rules, constraints, tiers, outcomes, and exclusion reasons | High-signal family and ambiguous-prose tests | 883 classified; 120 unclassified | 883 / 1,003 (88.04%) | SATISFIED |
| Section 5.2 semantic fact declarations | Every classified record declares stable required facts and capability roles; no address/offset/parser-family key is emitted | Classification shape and closed-schema tests | 883 / 883 classified records declare required facts | 883 / 883 (100.00%) | SATISFIED |
| Section 5.3 event and temporal declarations | Every classified record declares required events and one closed temporal scope | Classification shape and closed-schema tests | 883 / 883 records declare events and temporal scope | 883 / 883 (100.00%) | SATISFIED |
...
| Section 11.1 closed portable predicate vocabulary | Schema defines the required 21 operators; classified records select only operators from that closed set | Exact operator-enum and unknown-operator rejection tests | 883 / 883 classified records use only the closed vocabulary | 883 / 883 (100.00%) | SATISFIED |
| Section 11.2 portability tiers | Every record declares Tier 1–4; Tier 4 remains research-only | Tier bounds and summary tests | Tier 1: 449; Tier 2: 401; Tier 3: 33; Tier 4: 120 | 1,003 / 1,003 tiered (100.00%) | SATISFIED |
| Section 15.2 classified / extracted | Numeric report separates classified and unclassified references | Report-rendering test | 883 / 1,003 | 88.04% | SATISFIED |
| Section 15.2 expressible / classified | A record is expressible only when it has a known template key and Tier 1–3 semantic binding | Summary and schema tests | 883 / 883 | 100.00% | SATISFIED |
...
- Focused Node tests: 17 / 17 passed.
