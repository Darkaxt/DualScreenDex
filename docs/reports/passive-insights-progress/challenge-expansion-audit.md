...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Reference descriptions classified | 883 | 1,003 | 88.04% | 120 Tier 4 research exclusions | 0 | 0 |
| Classified descriptions expressible | 883 | 883 | 100.00% | 0 | 0 | 0 |
...
- Tier 4 ambiguous/glitch/trade/unavailable-frame references: **120/1,003 (11.96%) — 120 `NOT_APPLICABLE` to runtime generation** and retained only as documented research evidence.
