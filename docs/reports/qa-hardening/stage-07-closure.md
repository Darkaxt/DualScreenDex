...
| `REL-09` | `8bfaedd2` and the release workflows verify tag rules, protected signing/promotion environments, and reviewer policy without reading or publishing signing secrets. | `COMPLETE` |
