# First-50 table-hole closure plan

1. Freeze the exact first-50 table baseline and the Dreamstone real-ROM identity/result.
2. Add a SHA-bound Dreamstone live regression that requires complete typed level-up learnsets and deterministic semantic output; observe RED before production changes.
