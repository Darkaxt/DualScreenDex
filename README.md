...
| Signed candidate target | `v1.1.0-rc.59` is prepared for the protected signing workflow; [`v1.1.0-rc.58`](https://github.com/Darkaxt/DualScreenDex/releases/tag/v1.1.0-rc.58) remains the latest published prerelease until that workflow completes. |
