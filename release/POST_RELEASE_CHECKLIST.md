...
Verify the real user flow on the lower display: launch, ROM selection, catalog reopen, ROM-scoped settings persistence, capability report, and controller-focus acquisition/restoration. Do not claim the candidate is Thor-validated from signer or installation evidence alone.
...
Use the verified release URL, current screenshots/media, actual setup flow, AYN Thor focus guidance, first-50 compatibility scope, and truthful limitations. Run GAFT's documented preview/build checks and confirm links and media resolve.
