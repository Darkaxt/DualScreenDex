...
DualDex 1.2.0 RC5 packages the complete six-stage localization system. Manual Settings choices provide deterministic interface and ROM-content language selection even when `AUTO` cannot resolve a supported device or live-game language. It supersedes the failed RC1 through RC4 candidates with all Web, desktop-server, and ordinary CI test assertions aligned to the localized presentation contract.
...
- This candidate uses Android version code `1020005`.
