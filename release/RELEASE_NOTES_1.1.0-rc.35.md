...
RC35 corrects Local-map sign, entrance, and label presentation introduced with RC33. It supersedes the unpublished RC34 tag, whose pre-signing workflow stopped on a stale parser-schema test assertion and produced no APK or GitHub release.
...
- RC35 is an in-place prerelease update of `com.darkaxt.dualdex`.
