...
DualDex 1.2.0 RC1 packages the complete six-stage localization system. Manual Settings choices provide deterministic interface and ROM-content language selection even when `AUTO` cannot resolve a supported device or live-game language.
...
- This candidate uses Android version code `1020001`.
