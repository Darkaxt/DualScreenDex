...
const initialState = {
  ...
  activeRulesetId: null, rulesetAssumed: true, loading: { active: false, phase: 'COMPLETE', completedUnits: 5, totalUnits: 5 }, trainer: null, party,
};
...
test('party artwork remains dynamic and privacy-safe at 4:3', async ({ page }) => {
  ...
  await page.screenshot({ path: join(artifactDir, 'party-full-4x3.png') });
