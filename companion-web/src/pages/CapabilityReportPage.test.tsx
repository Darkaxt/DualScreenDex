...
describe('loaded ROM capability report', () => {
  ...
  it('copies only the stable diagnostic contract and reports fetch failures with retry', async () => {
    ...
    expect(copied).toContain('"reportSchemaVersion": 2');
    ...
    expect(copied).not.toContain('"romName"');
    expect(copied).not.toContain('"sha256"');
    expect(copied).not.toContain('"crc32"');
    expect(copied).not.toContain('"currentAreaBaseId"');
    expect(copied).not.toContain('"currentAreaName"');
    expect(copied).not.toContain('"localMapKey"');
    expect(copied).not.toContain('"sceneKey"');
    expect(copied).not.toContain('"atlasRegionKey"');
    expect(copied).not.toContain('"playerX"');
    expect(copied).not.toContain('"playerY"');
