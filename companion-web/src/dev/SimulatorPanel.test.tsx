...
describe('simulator ROM identity', () => {
  ...
  it('owns the attack-reference control while a simulated battle is active', () => {
    ...
    const state = {
      ...
      battle: { opponents: [], targetIndex: 0, targetMode: 'AUTOMATIC', capabilities: {}, selectedMoveId: 1, encounterKind: 'UNKNOWN', effectiveness: null, effectivenessKnown: false }, catalogReady: true,
